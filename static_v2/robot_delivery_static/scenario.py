...
def generate_scenario(
    ...
    # по минимальному расстоянию между роботами) и остаются в этих парах до
    # конца прогона. Генератор идентичен dynamic_v2 -- это позволяет
    # прогонять обе модели на буквально одних и тех же сценариях.
