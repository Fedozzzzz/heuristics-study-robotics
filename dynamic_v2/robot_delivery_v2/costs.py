"""
2.1. ROUTE-AND-COST --- вспомогательная процедура.
2.2. ESTIMATE-TASK-COST --- эвристическая оценка стоимости выполнения операции.

Модель взаимодействия внутри коалиции (обновлено): доставщик и строитель
