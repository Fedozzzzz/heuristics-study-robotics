...
def generate_scenario(
    ...
    # точки. В пары они склеиваются уже самой моделью на Шаге 2 (pairing.py;
    # в static_v3 -- СЛУЧАЙНЫМ образом) и остаются в этих парах до конца
    # прогона. Генератор идентичен static_v2 и dynamic_v2 -- это позволяет
    # прогонять все три модели на буквально одних и тех же сценариях.
